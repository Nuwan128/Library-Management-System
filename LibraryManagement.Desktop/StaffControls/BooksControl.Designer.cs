namespace LibraryManagement.Desktop
{
    partial class BooksControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            // BookDetailsGroupBox
            // 
            BookDetailsGroupBox.CustomizableEdges = customizableEdges1;
            BookDetailsGroupBox.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point);
            BookDetailsGroupBox.ForeColor = SystemColors.ControlText;
            BookDetailsGroupBox.Location = new Point(13, 14);
            BookDetailsGroupBox.Name = "BookDetailsGroupBox";
            BookDetailsGroupBox.ShadowDecoration.CustomizableEdges = customizableEdges2;
            BookDetailsGroupBox.Size = new Size(932, 464);
            BookDetailsGroupBox.TabIndex = 0;
            BookDetailsGroupBox.Text = "Book Detail";
            // 
            // BooksControl
            // 
